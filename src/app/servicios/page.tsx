...
export const metadata: Metadata = {
  ...
  keywords: [
    "servicios spa Monterrey",
    "precios spa Monterrey",
    "facial Monterrey precio",
    "limpieza facial profunda Monterrey",
    "facial hidratante Monterrey",
    "beauty lift facial Monterrey",
    "détox facial Monterrey",
    "masaje Monterrey precio",
    ...
    "reductivo abdomen Monterrey",
    "contorno corporal Monterrey",
    "aparatología corporal Monterrey",
    "paquete spa Monterrey",
  ],
